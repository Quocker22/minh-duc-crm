...
class StepperComponent {
  ...
  private _getStepContent = (index: number) => {
  ...
  private _getLastStepIndex = () => {
    return this.totatStepsNumber;
  };

  private _getTotalStepsNumber = () => {
    return this.totatStepsNumber;
  };
  ...
  private _isBetweenStep = () => {
    return this._isLastStep() === false && this._isFirstStep() === false;
  };
  ...
  public goLast = () => {
    return this.goto(this._getLastStepIndex());
  };
