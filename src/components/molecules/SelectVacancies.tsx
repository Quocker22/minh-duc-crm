...
export const SelectVacancies = <IForm extends object>(props: Props<IForm>) => {
  const { data, isLoading, isFetching } = useGetMasterList();
  const vacanciesList = useMemo(() => data?.find((i) => i.id === 'VI-TRI-TUYEN-DUNG'), [data]);
