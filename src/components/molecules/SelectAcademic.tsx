...
export const SelectAcademic = <IForm extends object>(props: Props<IForm>) => {
  const { data, isLoading, isFetching } = useGetMasterList();
  const academicList = useMemo(() => data?.find((i) => i.id === 'TRINH-DO-HOC-VAN'), [data]);
